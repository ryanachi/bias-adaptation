...
import csv
import json
cwd = Path("/u/scr/nlp/mercury/bias-adaptation/datasets/wikipedia")

def fetch_wikipedia(pickled=False):
    wikipedia_file_name = cwd / "wikipedia_utf8_filtered_20pageviews.csv"
    file_name = cwd / "wikipedia.pkl"
    if pickled:
